...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Venugopal Balan", "fb.com/venugopal.balan", "tc.venu@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Venu Spring Documentation", "Spring Learning", "1.0", "urn:tos",
